...
@Tag(name = "Contact Subject", description = "Endpoint ini digunakan untuk mengelola informasi mata kuliah yang terkait dengan seorang dosen, di Politeknik Statistika STIS.")
public class ContactSubjectController {
        ...
        @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(mediaType = "application/json", schema = @Schema(example = "{\"contactId\": \"{id}\", \"subjectId\": \"{id}\"}")))
        @ApiResponses(value = {
